...
export default function ParticleCanvas({ settings, inputPoint }) {
  ...
  useEffect(() => {
    ...
    function updateParticle(particle, index, time) {
      ...
      const dx = particle.x - inputPoint.x;
      const dy = particle.y - inputPoint.y;
      ...
      let targetX = inputPoint.x + Math.cos(angle) * distance;
      let targetY = inputPoint.y + Math.sin(angle) * distance;
      ...
      if (mode === 'orbit') {
        ...
        targetX = inputPoint.x + Math.cos(orbitAngle) * orbitDistance;
        targetY = inputPoint.y + Math.sin(orbitAngle) * orbitDistance;
      }
